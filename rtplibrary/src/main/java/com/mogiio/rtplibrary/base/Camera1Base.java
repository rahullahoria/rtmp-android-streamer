package com.mogiio.rtplibrary.base;
...
import com.mogiio.encoder.Frame;
import com.mogiio.encoder.audio.AudioEncoder;
import com.mogiio.encoder.audio.GetAacData;
import com.mogiio.encoder.input.audio.CustomAudioEffect;
import com.mogiio.encoder.input.audio.GetMicrophoneData;
import com.mogiio.encoder.input.audio.MicrophoneManager;
import com.mogiio.encoder.input.video.Camera1ApiManager;
import com.mogiio.encoder.input.video.CameraCallbacks;
import com.mogiio.encoder.input.video.CameraHelper;
import com.mogiio.encoder.input.video.CameraOpenException;
import com.mogiio.encoder.input.video.GetCameraData;
import com.mogiio.encoder.utils.CodecUtil;
import com.mogiio.encoder.video.FormatVideoEncoder;
import com.mogiio.encoder.video.GetVideoData;
import com.mogiio.encoder.video.VideoEncoder;
import com.mogiio.rtplibrary.util.FpsListener;
import com.mogiio.rtplibrary.util.RecordController;
import com.mogiio.rtplibrary.view.GlInterface;
import com.mogiio.rtplibrary.view.LightOpenGlView;
import com.mogiio.rtplibrary.view.OffScreenGlThread;
...
public abstract class Camera1Base
   ...
   *
   * @param cameraFacing front or back camera. Like: {@link com.mogiio.encoder.input.video.CameraHelper.Facing#BACK}
   * {@link com.mogiio.encoder.input.video.CameraHelper.Facing#FRONT}
   * @param width of preview in px.
   * @param height of preview in px.
   * @param rotation camera rotation (0, 90, 180, 270). Recommended: {@link
   * com.mogiio.encoder.input.video.CameraHelper#getCameraOrientation(Context)}
   */
